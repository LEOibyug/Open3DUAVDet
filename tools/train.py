...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/models/uavdet_3d/laa3d/centerdet_DORN_resnet152_aug_mixing_scale_w2d.yaml', help='specify the config for training')
    ...
    parser.add_argument('--tcp_port', type=int, default=12323, help='tcp port for distrbuted training')
