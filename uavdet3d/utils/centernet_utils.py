...
def draw_res_to_heatmap(heatmap_res_x, heatmap_res_y, center):

    x, y = center[0], center[1]

    height, width = heatmap_res_x.shape[0:2]
    ...
    heatmap_res_x[y_int, x_int] = res_x
    heatmap_res_y[y_int, x_int] = res_y

    return heatmap_res_x, heatmap_res_y
