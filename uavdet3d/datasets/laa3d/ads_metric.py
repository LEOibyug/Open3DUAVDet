...
class LAA3D_ADS_Metric():
    ...
    def evaluation_6dof_by_name(self, annos,
        ...
        orin_error, pos_error, size_error, all_x_error, all_y_error, all_z_error = eval_6d_pose(annos, max_dis=max_ass_dis)
        ...
        x_error_mean = all_x_error.mean()
        y_error_mean = all_y_error.mean()
        z_error_mean = all_z_error.mean()
        ...
        return_str = '\n\n' + cls_name + ':\n6dof error:\n    orin_error_mean(degree)： ' + str(orin_error_mean) + '\n' \
                     ...
                     + '    x_error_mean(m): ' + str(x_error_mean) + '\n' \
                     + '    y_error_mean(m): ' + str(y_error_mean) + '\n' \
                     + '    z_error_mean(m): ' + str(z_error_mean) + '\n' \
        ...
        mean_error_pd = pd.DataFrame({cls_name + '_orin_error_mean': [orin_error_mean],
                                      ...
                                      cls_name + '_x_error_mean': [x_error_mean],
                                      cls_name + '_y_error_mean': [y_error_mean],
                                      cls_name + '_z_error_mean': [z_error_mean],
