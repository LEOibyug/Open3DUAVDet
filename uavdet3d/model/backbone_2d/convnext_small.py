...
class ConvNeXtSmall(nn.Module):
    def __init__(self, model_cfg):
        ...
        self.lateral8 = nn.Conv2d(192, self.feature_channels, 1)
        self.lateral16 = nn.Conv2d(192, self.feature_channels, 1)
        self.lateral32 = nn.Conv2d(384, self.feature_channels, 1)
