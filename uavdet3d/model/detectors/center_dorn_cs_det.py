...
class CenterDORNCSDet(DetectorTemplate):
    def __init__(self, model_cfg, dataset):
        ...
        self.depth_num = self.model_cfg.POST_PROCESSING.DEPTH_NUM
        self.norm_max_dis = self.model_cfg.POST_PROCESSING.NormMaxDis
        self.max_size = self.model_cfg.POST_PROCESSING.NormMaxSize
